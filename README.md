...
- **Standard base‑6 conversion** – dice rolls treated as a base‑6 number (1→0, 2→1, …, 6→5).    - **Verified against Ian Coleman** – pasting generated seed words produces identical entropy hex, account keys, and addresses.
