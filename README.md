...
![Dice Rolls Input](Input.jpg)

### Output — Your generated BIP39 seed phrase
![Generated Seed Phrase](Output.jpg)
...
**To verify this tool:** Use iancoleman.io/bip39 with **"Base 6 [0-5]"** or **"Hex"** entropy mode.
...
These test vectors were cross-checked against iancoleman.io/bip39 using **Hex entropy mode**.
...
1. Go to iancoleman.io/bip39 (download the offline standalone version for security)
...
- Ian Coleman for the canonical BIP39 reference implementation
